<template>
  <div class="home-container">
    <!-- Top Navigation Bar -->
    <nav class="navbar">
      <div class="nav-brand">SWARMSIGHT</div>
      <div class="nav-links">
        <a href="https://github.com/SwarmSight/SwarmSight" target="_blank" class="github-link">
    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even from a single paragraph of text, <span class=”highlight-bold”>SwarmSight</span> can automatically extract real-world seeds and generate a parallel world with up to <span class=”highlight-orange”>million-scale Agents</span>. Inject variables from a god's-eye view and find <span class=”highlight-code”>locally optimal solutions</span> in complex group interactions.
            </p>
            <p class="slogan-text">
              Let the future rehearse in agent swarms, let decisions prevail after a thousand battles<span class="blinking-cursor">_</span>
            </p>
          </div>
        ...
        <div class="hero-right">
          ...
          <div class="logo-container">
            <div class="text-logo">SwarmSight</div>
          </div>
        ...
        <div class="left-panel">
          ...
          <div class="metrics-row">
            ...
            <div class="metric-card">
              ...
              <div class="metric-label">Up to million-scale Agent simulations</div>
            </div>
          </div>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual-platform parallel simulation & auto-parsing prediction requirements & dynamic timeline memory updates</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">ReportAgent has rich toolsets for deep interaction with the post-simulation environment</div>
                </div>
              </div>
              <div class="workflow-item">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter simulation or prediction requirements in natural language (e.g., What public opinion trends would emerge if University X released a statement reversing the expulsion of a student?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
                <div class="model-badge">Engine: SwarmSight-V1.0</div>
              </div>
            </div>
      ...
      <div class="powered-by-footer">Powered by XGX.ai</div>
    </div>
  </div>
</template>
