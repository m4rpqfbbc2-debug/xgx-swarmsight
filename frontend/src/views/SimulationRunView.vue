  ...
  <div class="main-view">
    ...
    <header class="app-header">
      <div class="header-left">
        <div class="brand" @click="router.push('/')">SWARMSIGHT</div>
      </div>
...
// Get maxRounds from query params at init time to ensure child components get the value immediately
...
onMounted(() => {
  ...
  // Record maxRounds config (value already obtained from query params at init time)
  if (maxRounds.value) {
