...
# Get logger
logger = get_logger('swarmsight.api')
...
def build_graph():
    ...
    """
    try:
        logger.info("=== Starting knowledge graph building ===")
        ...
        # Get configuration
        graph_name = data.get('graph_name', project.name or 'SwarmSight Graph')
        ...
        def build_task():
            build_logger = get_logger('swarmsight.build')
            try:
