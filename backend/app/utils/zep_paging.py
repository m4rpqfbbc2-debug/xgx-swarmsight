"""Zep Graph paginated retrieval utility.

Zep's node/edge list API uses UUID cursor-based pagination.
This module wraps the automatic page traversal logic (with per-page retry),
...
logger = get_logger('swarmsight.zep_paging')
...
def fetch_all_nodes(
    ...
    """Fetch graph nodes with pagination, returning up to max_items (default 2000). Each page request includes retry."""
    all_nodes: list[Any] = []
