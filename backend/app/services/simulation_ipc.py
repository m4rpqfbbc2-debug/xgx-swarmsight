...
logger = get_logger('swarmsight.simulation_ipc')
...
class SimulationIPCClient:
    ...
    def send_command(
        ...
        raise TimeoutError(f"Command response timed out ({timeout} seconds)")
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Specified platform (optional)
                ...
                - None: Interview on both platforms in dual-platform simulation, interview on that platform in single-platform simulation
            timeout: Timeout
