...
Read nodes from Zep graph, filter out nodes matching predefined entity types
"""
...
logger = get_logger('swarmsight.zep_entity_reader')
...
class ZepEntityReader:
    ...
    def filter_defined_entities(
        ...
        Filtering logic:
        - If a node's Labels only contain "Entity", the entity does not match our predefined types; skip it
