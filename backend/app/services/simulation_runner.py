...
logger = get_logger('swarmsight.simulation_runner')
...
class SimulationRunner:
    ...
    def _check_all_platforms_completed(cls, state: SimulationRunState) -> bool:
        ...
        Determines if platform is enabled by checking whether corresponding actions.jsonl file exists
        ...
        # Check which platforms are enabled (judged by file existence)
    ...
    def register_cleanup(cls):
        ...
        # In non-debug mode, this env var does not exist, still need to register
    ...
    def interview_agent(
        ...
        Args:
            ...
            platform: Specified platform (optional)
                ...
                - None: Interview on both platforms in dual-platform simulation, return integrated results
