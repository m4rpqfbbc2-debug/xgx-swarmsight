...
logger = get_logger('swarmsight.simulation')
...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        3. Use LLM to intelligently generate simulation parameters (time, activity, posting frequency, etc.)
        ...
        try:
            ...
            if filtered.filtered_count == 0:
                ...
                state.error = "No qualifying entities found, please check if the graph is correctly constructed"
                self._save_simulation_state(state)
                return state
    ...
    def get_run_instructions(self, simulation_id: str) -> Dict[str, str]:
        ...
        return {
            ...
            "instructions": (
                f"1. Activate conda environment: conda activate SwarmSight\n"
