...
logger = get_logger('swarmsight.zep_graph_memory_updater')
...
class ZepGraphMemoryUpdater:
    ...
    Groups by platform, batch-sends to Zep after accumulating BATCH_SIZE activities per platform.

    All meaningful behaviors are updated to Zep, with action_args containing full context information:
    ...
    # Batch send size (how many items per platform before sending)
    BATCH_SIZE = 5
    ...
    def add_activity(self, activity: AgentActivity):
        ...
        action_args contains full context information (such as original post text, usernames, etc.).
